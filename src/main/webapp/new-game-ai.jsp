...
<html lang="ru">
  <head>
    ...
    <script type="text/javascript" src="js/new-game-ai.js"></script>
  </head>
  <body>
        ...
        <div class="container">
          ...
          <div class="row">
            <form>
              ...
              label(for="friend") Пригласить друга
              
              -->
              <div class="col s12"><a id="new-game-ai-btn" type="submit" name="action" class="btn waves-effect waves-light">Создать игру<i class="material-icons right">send</i></a></div>
            </form>
          </div>
        </div>
      </div>
