...
test('TrackerGroup', function (t) {
  ...
  function afterFinishEmpty (er, onChangeName, completion) {
    ...
    t.is(onChangeName, name, 'finishEmpty: on change emits the correct item')
  ...
  function afterCompleteWork (er, onChangeName, completion) {
    ...
    t.is(onChangeName, 'a', 'on change emits the correct item')
  ...
  function afterFinishAll (er, onChangeName, completion) {
    ...
    t.is(onChangeName, name, 'finishAll: on change emits the correct item')
  ...
  function afterWeightedCompleteWork (er, onChangeName, completion) {
    ...
    t.is(onChangeName, 'a', 'weighted: on change emits the correct item')
  ...
  function afterWeightedFinishAll (er, onChangeName, completion) {
    ...
    t.is(onChangeName, name, 'weightedFinishAll: on change emits the correct item')
  ...
  function afterNestedComplete (er, onChangeName, completion) {
    ...
    t.is(onChangeName, 'b', 'nestedComplete: on change emits the correct item')
